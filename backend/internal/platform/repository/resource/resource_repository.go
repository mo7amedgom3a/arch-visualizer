...
// NewResourceRepositoryWithDB creates a new resource repository with a custom DB
func NewResourceRepositoryWithDB(db *gorm.DB, logger *slog.Logger) *ResourceRepository {
